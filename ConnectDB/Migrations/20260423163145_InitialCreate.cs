...
namespace ConnectDB.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ServiceAreaPrices",
                columns: table => new
                {
                    ServiceAreaPriceId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ServiceId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceAreaPrices", x => x.ServiceAreaPriceId);
                    table.ForeignKey(
                        name: "FK_ServiceAreaPrices_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceAreaPrices_ServiceId",
                table: "ServiceAreaPrices",
                column: "ServiceId");
